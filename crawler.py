...
url = "http://bison.uni-weimar.de/qisserver/rds?state=wplan&raum.rgid=[raumid]&week=[calendar_week]_[year]&act=Raum&pool=Raum&show=plan&P.vx=lang&fil=plu&P.subc=plan"
